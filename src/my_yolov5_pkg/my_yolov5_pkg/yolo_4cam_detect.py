...
class Yolo5Ros(Node):
    def __init__(self):
        ...
        self.pub_bbox_3 = self.create_publisher(BoundingBoxes, 'yolov5/bounding_boxes_3', 1)
        self.pub_bbox_4 = self.create_publisher(BoundingBoxes, 'yolov5/bounding_boxes_4', 1)
        ...
        self.pub_image_3 = self.create_publisher(Image, 'yolov5/image_raw_3', 1)
        self.pub_image_4 = self.create_publisher(Image, 'yolov5/image_raw_4', 1)
        ...
        self.sub_image_3 = self.create_subscription(Image, 'img_3', self.image_callback_3,1)
        self.sub_image_4 = self.create_subscription(Image, 'img_4', self.image_callback_4,1)
    ...
    def image_callback_3(self, image:Image):
        #changes to color format BGR
        # image_raw = self.bridge.imgmsg_to_cv2(image, "bgr8")
        print('running for third camera image')
        image_raw = self.bridge.imgmsg_to_cv2(image)
        
        # return (class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list)
        class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list = self.yolov5.image_callback_pp(image_raw, "src_3")

        msg = self.yolovFive2bboxes_msgs(bboxes=[x_min_list, y_min_list, x_max_list, y_max_list], scores=confidence_list, cls=class_list, img_header=image.header)
        self.pub_bbox_3.publish(msg)

        self.pub_image_3.publish(image)
    ...
    def image_callback_4(self, image:Image):
        #changes to color format BGR
        # image_raw = self.bridge.imgmsg_to_cv2(image, "bgr8")
        print('running for fourth camera image')
        image_raw = self.bridge.imgmsg_to_cv2(image)
        
        # return (class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list)
        class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list = self.yolov5.image_callback_pp(image_raw, "src_4")

        msg = self.yolovFive2bboxes_msgs(bboxes=[x_min_list, y_min_list, x_max_list, y_max_list], scores=confidence_list, cls=class_list, img_header=image.header)
        self.pub_bbox_4.publish(msg)

        self.pub_image_4.publish(image)
